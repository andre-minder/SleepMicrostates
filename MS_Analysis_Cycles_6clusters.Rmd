---
title: "Microstate Analysis - Sleep Cycles - 6 Clusters"
author: "André Minder"
date: "2024-03-05"
output:
  html_document:
...
data_long_duration <- data_ms_clean |> 
  ...
  mutate(type = str_sub(type, -1, -1),
         ...
         type = fct_recode(type, "F" = "G"),
         type = fct_relevel(type, c("A", "B", "C", "D", "E", "F")))
...
### Model
```{r}
duration_model <- lmer(duration ~ cycle * stage * type + 
